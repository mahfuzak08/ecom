        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 f-col">
                    <h3><?= lang('about_us') ?></h3>
                    <p><?= $footerAboutUs ?></p>
                    <?php if($publicVisitor > 0) { ?>
                        <div class="row numscroller_row hidden-lg hidden-md hidden-sm">
                            <div class="col-xs-6 numscroller_label">Total Visitors</div><div class='col-xs-6 numscroller' data-slno='1' data-min='0' data-max='<?= $publicVisitor+$visitor_count ?>' data-delay='5' data-increment="13">0</div>
                        </div>
                    <?php } ?>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 hidden-xs f-col">
                    ...
                    <?php if($publicVisitor > 0) { ?>
                    <div class="col-xs-6 numscroller_label">Visitors</div><div class='col-xs-6 numscroller' data-slno='1' data-min='0' data-max='<?= $publicVisitor+$visitor_count ?>' data-delay='5' data-increment="13">0</div>
                    <?php } ?>
                    <ul class="social">
...
<div class="hidden-lg hidden-md hidden-sm nav-bottom">
    ...
    <div class="col">
        <a href="<?= LANG_URL . '/shopping-cart' ?>">
            <div class="bscart"><span class="sumOfItems"><?= is_array($cartItems) ? $sumOfItems : 0; ?></span></div>
