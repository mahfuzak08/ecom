            ...
            <div class="loginmodal-container">
                ...
                <form method="POST" action="">
                    <div class="form-group has-feedback">
                        <input type="password" name="pass" class="form-control" placeholder="Old Password" <?= $readonly ?>> 
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" name="pass" class="form-control" placeholder="New Password" <?= $readonly ?>> 
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" name="pass" class="form-control" placeholder="Confirm Password" <?= $readonly ?>> 
                    </div>
                    <div class="form-group has-feedback">
