            ...
            <div class="col-sm-9 left-side">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-products">
                                ...
                                <tbody>
                                    ...
                                    <?php } ?>
                                    <?php 
                                    if ($shippingOrder != 0 && $shippingOrder != null && (float)str_replace(",", "", $cartItems['finalSum']) > 999) {
                                        $cartItems['finalSum'] = (float)str_replace(",", "", $cartItems['finalSum']) - $cartItems['shipping'];
                                        $cartItems['shipping'] = 0;
                                    }
                                    ?>
                                    <tr>
                                        <td colspan="4" class="text-right"><?= lang('shippingCost') ?></td>
                                        <td>
                ...
                <?php } elseif(isset($_SESSION['logged_in'])) { ?>
                    <form method="POST" id="goOrder">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <label for="phoneInput"><?= lang('phone') ?> <sup class="requires"><?= lang('requires') ?></sup></label>
                                <input id="phoneInput" data-uri="<?= base_url("checkout") ?>" class="form-control phoneInput" value="<?= @$_POST['phone'] ?>" name="phone" type="text" placeholder="<?= lang('phone') ?>">
                            </div>
                            <div class="form-group col-sm-12" id="user_lists"><ul></ul></div>
                            <div class="form-group col-sm-6">
                                <label for="emailAddressInput"><?= lang('email_address') ?></label>
                                <input id="emailAddressInput" class="form-control" name="email" type="text" value="<?= @$_POST['email'] ?>" placeholder="<?= lang('email_address') ?>">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="cityInput"><?= lang('shippingArea') ?> <sup class="requires"><?= lang('requires') ?></sup></label>
                                <select name="city" id="cityInput" class="form-control" onchange="setShippingCost()">
                ...
                <?php } else { ?>
                    <p class="promot-to-login">
                        ...
                        New to <?= DISPLAY_NAME; ?>? Please <a href="<?= LANG_URL . '/register' ?>"><?= lang('register') ?></a>
                    </p>
                    <div class="table-responsive">
                        <table class="table table-bordered table-products">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" class="text-right"><?= lang('shippingCost') ?></td>
                                    <td><span class="shipping"><?= $cartItems['shipping'] ?></span><?= CURRENCY ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right"><?= lang('total') ?></td>
                                    <td>
...
<script>
    function setShippingCost(){
        ...
        if(Number($("#product-amt").val()) < <?= $shippingOrder ?>){
