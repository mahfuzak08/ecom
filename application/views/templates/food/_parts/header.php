                                    ...
                                    <div class="input-group-btn">
                                        <div class="btn-group" role="group">
                                            <div class="dropdown dropdown-lg">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" id="suggestions" role="menu">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 hidden-xs">
                                <div class="basket-box">
                                    <table>
                                        <tr>
                                            <td>
                                                <div id="openWishCart" class="basket" style="background:url('<?= base_url('template/imgs/green-basket.png') ?>')">
                                                    <span class="sumOfWish"></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="center">
