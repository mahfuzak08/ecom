...
<h1><img src="<?= base_url('assets/imgs/admin-home.png') ?>" class="header-img" style="margin-top:-3px;"> <?= $description; ?></h1>
<hr>
<div class="home-page">
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel panel-red">
                ...
                <a href="<?= base_url('admin/products?order_by=quantity%3Dasc&reorder_level=y') ?>">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
