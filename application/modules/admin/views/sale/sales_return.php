    ...
    <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
            <div id="invoice" class="box box-success table-responsive">
                ...
                <?= form_open('admin/sale/return_item/'.$order['id'], array('id'=>'return_item_form')); ?>
                <?php } ?>
                    <table width="100%">
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        <td style="vertical-align: top;padding:10px;">
                                            ...
                                            switch($order['order_type']){
                                                case 'sale':
                                                    echo 'Sales Invoice'; break; 
                                                case 'sale_void' :
                                                    echo 'Invoice Deleted'; break;
                                                case 'sale_return':
                                                    echo 'Sales Return'; break;
                                                default:
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tbody id="cart_contents">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="border-bottom: 1px dashed;width:8%;padding: 5px;text-align:center;"><input type="text" <?= $order['order_type'] != 'sale' ? 'disabled' : '' ?> name="qty<?= $line; ?>" value="<?= $item['product_info']['quantity']; ?>" size="5" style="text-align: center"><?= form_hidden('old_qty'.$line, $item['product_info']['quantity']); ?></td>
                                ...
                                <table style="width:100%; margin-top:10px;">
                                    <tr>
                                        <td>
                                            <input name="return_note" value="<?= $order['order_type'] == 'sale_return' ? @$order['note'] : ''; ?>" type="text" <?= $order['order_type'] != 'sale' ? 'disabled' : '' ?> class="form-control" placeholder="Sales Return Note">
                                        </td>
                                        <td>
                                            <button type="submit" <?= $order['order_type'] != 'sale' ? 'disabled' : '' ?> name="return_btn" class="btn btn-info btn-block btn-flat" data-form-id="return_item_form" data-msg="Are you sure want to return? This action cannot be undone.">Return</button>
                                        </td>
                                    </tr>
                                    <tr><td colspan="2">&nbsp;</td></tr>
                                    <tr>
                                        <td>
                                            <input name="delete_note" value="<?= $order['order_type'] == 'sale_void' ? $order['note'] : ''; ?>" type="text" <?= $order['order_type'] != 'sale' ? 'disabled' : '' ?> class="form-control" placeholder="Sales Delete Note">
                                        </td>
                                        <td>
                                            <button type="submit" <?= $order['order_type'] != 'sale' ? 'disabled' : '' ?> name="delete_btn" class="btn btn-danger btn-block btn-flat" data-form-id="return_item_form" data-msg="Are you sure want to delete this invoice? This action cannot be undone.">Delete</button>
                                        </td>
                                    </tr>
                                </table>
                            </td>
