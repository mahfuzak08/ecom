                ...
                <table style="width: 350px; margin-left: 150px;">
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tfoot>
                                        <tr>
                                            <td colspan="2" rowspan="5" style="vertical-align: top;padding: 5px; text-align:right;">Total Quantity <br><br>
                                            <img src="data:image/png;base64,<?= $barcode; ?>">
                                            </td>
                                            <td style="border-bottom: 1px dashed;text-align:center;padding: 5px;"><?= $tq; ?></td>
                                            <td style="border-bottom: 1px dashed;text-align:right;padding: 5px;">Sub Total</td>
                    ...
                    <tr>
                        ...
                        <table style="width:100%; margin-top:10px; background:#F9F9F9;">
                            <tr>
                                <td style="border-top:1px solid;padding: 5px; text-align:center;">This is a software generated invoice.<br><b>Powred By ABSoft-BD.COM</b></td>
                            </tr>
                        </table>
                        </td>
                    </tr>
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" action="<?= site_url("admin/settings"); ?>">
                                ...
                                <div class="radio">
                                    ...
                                    <label><input type="radio" name="page_width" value="50" <?= $page_width == "50" ? 'checked' : '' ?>> Half width ( 50% )</label>
                                </div>
