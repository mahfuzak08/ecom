                            ...
                            <table width="100%">
                                <tr>
                                    <td style="vertical-align: top;padding:10px;">
                                        ...
                                        <?= $order['order_type'] == 'purchase_return' ? '<h4>Purchase Return</h4>' : '<h4><b>'.$description.'</b></h4>'; ?>
                                    </td>
                                    <td style="vertical-align: top;padding:10px;">
                        ...
                        <td>
                            <table>
                                ...
                                <tfoot>
                                        ...
                                        <?php if($order['referrer'] == "POS"): 
                                            foreach(unserialize($order['payment_type']) as $pay){
                                                if($pay['payment_title'] == 'Advance' || $pay['payment_title'] == 'Collection'): 
                                                    $pay['payment_title'] = $pay['payment_title'] == 'Collection' ? 'Dues' : $pay['payment_title']; ?>
                                                <tr>
                                                    <td colspan="3" style="padding: 5px;">&nbsp;</td>
                                                    <td colspan="2" style="border-bottom: 1px dashed;text-align:right;padding: 5px;"><?= $pay['payment_title']; ?> </td>
                                        ...
                                        <tr>
                                            <td colspan="3" style="padding: 5px;">&nbsp;</td>
                                            <td colspan="2" style="border-bottom: 1px dashed;text-align:right;padding: 5px;font-weight:700;font-size:15px;color:#F00;">Current Dues</td>
