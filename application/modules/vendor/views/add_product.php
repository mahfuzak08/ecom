    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="content">
            <form class="form-box" action="" method="POST" enctype="multipart/form-data">
                ...
                ?>
                <div class="form-group">
                    <input type="text" name="price" value="<?= $trans_load != null && isset($trans_load[MY_DEFAULT_LANGUAGE_ABBR]['price']) ? $trans_load[MY_DEFAULT_LANGUAGE_ABBR]['price'] : '' ?>" placeholder="<?= lang('vendor_price') ?>" class="form-control">
                </div>
                <div class="form-group">
                    <input type="text" name="old_price" value="<?= $trans_load != null && isset($trans_load[MY_DEFAULT_LANGUAGE_ABBR]['price']) ? $trans_load[MY_DEFAULT_LANGUAGE_ABBR]['price'] : '' ?>" placeholder="<?= lang('vendor_old_price') ?>" class="form-control">
                </div>
