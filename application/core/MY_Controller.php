...
class MY_Controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->library('count_visitor');
    }
    ...
    public function render($view, $head, $data = null, $footer = null)
    {
        ...
        $this->count_visitor->set_visitor_count();
    }
    ...
    private function loadVars()
    {
        ...
        $vars['siteOverview'] = $this->Home_admin_model->getValueStore('siteOverview');
        $vars['siteico'] = $this->Home_admin_model->getValueStore('siteico');
        $vars['siteAPK'] = $this->Home_admin_model->getValueStore('siteAPK');
		...
		$vars['officeTimeStart'] = $this->Home_admin_model->getValueStore('officeTimeStart');
        $vars['officeTimeEnd'] = $this->Home_admin_model->getValueStore('officeTimeEnd');
		...
		$vars['footerContactEmailPass'] = htmlentities($this->Home_admin_model->getValueStore('footerContactEmailPass'));
        ...
        $vars['visitor_count'] = $this->count_visitor->get_visitor_count(false, 'sum');
        $vars['publicVisitor'] = $this->Home_admin_model->getValueStore('publicVisitor');
     ...
     */
    public function getHomeCategories($categories)
    {
